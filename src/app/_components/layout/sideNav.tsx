...
export default function SideNav({ active }: any) {
  ...
  return (
    <div className={`${styles.container} ${active && styles.sidebar_active}`}>
      ...
      <div >
        <Link href={"/"} className={`${styles.flex_container} ${"/" === route && styles.link_active}`}>
                  ...
                  <div className={styles.sub_container}>
                    {
                      nav.sub.map(sub => {
                        return (
                          <Link href={`${sub.text === "Users" ? "/" + sub.text.toLowerCase() : ""}`} className={`${styles.link_container} ${"/" + sub.text.toLowerCase() === route && styles.link_active}`} key={sub.text}>
